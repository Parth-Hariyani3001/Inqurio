  ...
  return (
    <article className="flex flex-col gap-2 px-4 py-5 sm:px-6">
      <div className="flex items-start gap-2">
        <h2 className="min-w-0 flex-1 text-lg font-medium tracking-tight text-foreground sm:text-xl">
          <Link
      ...
      <p className="font-serif text-sm text-muted-foreground">{session.paper_title}</p>
