    ...
    <main>
      <section className="mx-auto grid max-w-6xl gap-12 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.05fr)] lg:items-center lg:gap-16 lg:py-24">
        <div>
          ...
          <h1 className="mt-4 max-w-xl font-display text-4xl leading-[1.12] tracking-tight sm:text-5xl">
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
        <p className="text-muted-foreground text-sm">How you work</p>
        <h2 className="mt-3 max-w-lg font-display text-3xl tracking-tight">
          ...
          {steps.map((step, index) => (
            <li key={step.name}>
              ...
              <div className="grid gap-3 py-8 sm:grid-cols-[8rem_minmax(0,32rem)] sm:gap-10">
                <p className="font-display text-xl text-foreground">{step.name}</p>
