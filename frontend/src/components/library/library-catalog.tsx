...
import { LibraryResult } from '#/components/library/library-result.tsx'
import type { UserPaperResponse } from '#/lib/user-papers.ts'
...
export function LibraryCatalog({
  ...
  query: string
  results: Array<UserPaperResponse>
  rangeStart: number
  rangeEnd: number
  hasPrev: boolean
  hasNext: boolean
