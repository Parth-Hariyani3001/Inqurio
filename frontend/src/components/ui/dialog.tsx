...
function DialogOverlay({
  ...
  return (
    <ModalOverlayPrimitive
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-black/10 duration-250 ease-out data-entering:animate-in data-entering:fade-in-0 data-exiting:animate-out data-exiting:fade-out-0 supports-backdrop-filter:backdrop-blur-xs",
        className
      )}
      {...props}
    >
  ...
  return (
    <DialogOverlay isDismissable={isDismissable} {...props}>
      <ModalPrimitive
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-50 grid w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl bg-popover p-4 text-sm text-popover-foreground ring-1 ring-foreground/10 duration-250 ease-out outline-none data-entering:animate-in data-entering:fade-in-0 data-entering:zoom-in-95 data-exiting:animate-out data-exiting:fade-out-0 data-exiting:zoom-out-95 sm:max-w-sm",
          className
        )}
      >
        <DialogPrimitive
