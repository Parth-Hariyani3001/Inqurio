...
function SheetOverlay({
  ...
  return (
    <ModalOverlayPrimitive
      ...
      isDismissable
      className={cn(
        "fixed inset-0 z-50 bg-black/10 transition-opacity duration-400 ease-[var(--ease-drawer)] data-entering:opacity-0 data-exiting:opacity-0 supports-backdrop-filter:backdrop-blur-xs",
        className
      )}
      {...props}
    >
